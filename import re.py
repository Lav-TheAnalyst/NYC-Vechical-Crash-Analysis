...
k=[]
print("nee")
for i in get_list_of_dates_to_process("2022-01-30"):
    try:
        n=format_data(i,"e1f10a1e78da46f5b10a1e78da96f525")
...
kn.to_csv(r'C:\Users\lavsingh2\Downloads\We.csv', index=False)
